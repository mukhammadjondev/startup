...
const Footer = () => {
  ...
  return (
    <Box pl={{ base: 0, lg: '320px' }} mt={10} w={'full'} borderTop={'1px'} bg={useColorModeValue('gray.50', 'gray.900')} color={useColorModeValue('gray.700', 'gray.200')} borderTopColor={useColorModeValue('gray.200', 'gray.700')} h={'10vh'}>
      <Flex justify='space-between' align='center' h='full'>
        <Text>© {format(new Date(), 'yyyy')} MuhsDev. {t('footer', {ns: 'layout'})}</Text>
        <Flex gap={3} mr={10}>
