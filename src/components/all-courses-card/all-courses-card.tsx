    ...
    <Box py={4}>
      <Flex gap={4} direction={{base: 'column', md: 'row'}}>
        ...
        <Stack>
          ...
          <Text>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quaerat beatae nemo, eos maiores culpa facere.</Text>
          ...
          <Divider />
          <Flex align={{bae: 'flex-start', md: 'center'}} justify='space-between' direction={{base: 'column', md: 'row'}}>
            <Text fontSize='xl' fontWeight='bold'>{course.price.toLocaleString('en-US', {style: 'currency', currency: 'USD'})}</Text>
