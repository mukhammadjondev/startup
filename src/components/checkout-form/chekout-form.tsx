...
export default function CheckoutForm() {
	...
	return (
		<form id='payment-form' onSubmit={handleSubmit}>
			...
			<Button w='full' h={14} mt={5} isDisabled={isLoading || !stripe || !elements} isLoading={isLoading} boxShadow='xl' type='submit'>
				Pay now {getTotalPrice(courses, books).toLocaleString('en-US', {style: 'currency', currency: 'USD'})}
			</Button>
		</form>
	)
}