...
const BooksModal: FC<BooksModalProps> = ({isOpen, onClose, booksValue}): JSX.Element => {
  ...
  const { startBooksLoading, createBooks, updateBooks, clearBooksError } = useActions()
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} isCentered={true} size={'xl'}>
      ...
      <ModalContent>
        ...
        <ModalCloseButton />
        <Formik onSubmit={onSubmit} initialValues={values} validationSchema={BooksValidation.createBooks} enableReinitialize>
          <Form>
            <ModalBody>
