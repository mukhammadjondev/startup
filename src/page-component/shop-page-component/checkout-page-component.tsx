...
import { Box, Divider, Grid, GridItem, HStack, Skeleton, Stack, Text, useColorModeValue } from "@chakra-ui/react"
...
const CheckoutPageComponent = () => {
  ...
  return <>
    ...
    <Grid gridTemplateColumns='70% 30%' gap={5}>
      ...
      <GridItem mt={10} borderLeft='1px' p={5} borderColor={useColorModeValue('gray.200', 'gray.700')}>
            ...
            <HStack justify='space-between'>
              <HStack>
                <Box pos='relative' w='40px' h='30px'>
                  <Image src={loadImage(book.image)} fill alt={book.title} style={{objectFit: 'cover'}} />
                </Box>
