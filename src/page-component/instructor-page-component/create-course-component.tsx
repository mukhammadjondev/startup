...
const CreateCourseComponent = () => {
  ...
  return <>
    <SectionTitle title={t('create_course_title', {ns: 'instructor'})} subtitle={t('create_course_description', {ns: 'instructor'})} />
    <Divider mt={5} />
    <InstructorManageCourse titleBtn={t('create_course_btn', {ns: 'instructor'})} submitHandler={onSubmit} />
  </>
}
