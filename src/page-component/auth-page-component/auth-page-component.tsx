...
const AuthPageComponent = () => {
  ...
  return <>
    <AuthNavbarComponent />
    <Box pos='relative'>
      <Container as={SimpleGrid} maxW='7xl' columns={{base: 1, md: 2}} spacing={{base: 10, md: 32}}>
        <Stack spacing={{base: 10, md: 20}} py={{base: 10, sm: 20, lg: 24}}>
        ...
        <Stack bg={useColorModeValue('gray.50', 'gray.900')} h='fit-content' rounded='xl' p={{base: 4, sm: 6, md: 8}} spacing={{base: 8}} maxW={{lg: 'lg'}} my={{base: 4, lg: 8}}>
