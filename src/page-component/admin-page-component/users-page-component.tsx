...
const UsersPageComponent = () => {
  ...
  return <>
    <Card mt={10}>
      <CardBody>
        <Stack>
          <SectionTitle title={t('user_section_title', {ns: 'admin'})} subtitle={t('user_section_descr', {ns: 'admin'})} />
    ...
    <Box mt={10}>
      ...
      <TableContainer mt={10}>
        <Table variant='striped' colorScheme='teal'>
          <TableCaption>
            <Button variant='outline' colorScheme='facebook' rightIcon={<AiOutlineReload />} isLoading={isLoading} onClick={moreAdminUsersHandler}>
