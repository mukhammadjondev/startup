    ...
    <Card my={10}>
      <CardBody>
        <Carousel responsive={testimonialsCarousel}>
          <Box w='full' h={{base: '40vh', lg: '50vh'}} backgroundImage={`url(${article.image.url})`} backgroundPosition='center' backgroundSize='cover' backgroundRepeat='no-repeat' pos='relative'>
