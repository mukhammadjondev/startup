...
export const sendVerificationCode = createAsyncThunk<'Success', {email: string}>('auth/verification-code',
...
export const verifyVerificationCode = createAsyncThunk<'Success', InterfaceEmailAndOtp>('auth/verify-code',
